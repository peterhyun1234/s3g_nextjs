...
const descriptionList = [
  ...
  {
    name: '선물',
    simpleDescription: "선물이 주 언어인 선물이 사람들은 선물이 사랑을 표현하는 수단이라 생각하며 사랑을 나타내는 상징이라 생각합니다.",
    description: "어떤 사람들은 아름다운 보석이나, 값비싼 물건을 선물해야만 사랑이 전달된다고 생각합니다. 하지만 이 사람들에겐 아주 작은 선물이라도 사랑이 전달되기엔 충분합니다. 주는 사람의 마음만 듬뿍 담겨 있다면 선물의 크고 작음에는 전혀 관계가 없습니다. 당신이 전하는 사랑이 듬뿍 담긴 작은 쪽지 하나라도 이 사람들에겐 평생 간직 하고싶은 큰 선물일 것입니다."
  },
  {
    name: '봉사의 손길',
  ...
  {
    name: '스킨십',
    simpleDescription: "스킨십이 주 언어인 누군가 손을 잡아 주거나 어깨를 한번 두드려주는 것만으로도 힘을 얻습니다.",
    description: "이 사람들은 힘들 때 누군가 손을 잡아 주거나 어깨를 한번 두드려주는 것만으로도 아주 큰 힘을 얻습니다. 상대방이 손으로 머리를 쓰다듬고 사랑을 듬뽁담아 안아준다면 \"난 혼자가 아니야\", \"행복하다\"란 사랑의 감정을 느끼게 될 것입니다."
  },
];
